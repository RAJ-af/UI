...
export default function ScanDoubtsPage() {
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Scan & Solve Doubts</h1>
            ...
            {scanResult && (
              <div className="bg-white rounded-lg shadow-sm p-6">
                <div className="flex items-center mb-4">
                  ...
                  <h2 className="text-xl font-semibold">Solution Found!</h2>
                </div>

                <div className="space-y-4">
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Detected Problem:</h3>
                    <p className="text-gray-700 bg-gray-50 p-3 rounded">{scanResult.question}</p>
                  </div>

                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Answer:</h3>
                    <p className="text-lg font-bold text-green-600 bg-green-50 p-3 rounded">{scanResult.solution}</p>
                  </div>

                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Step-by-step Solution:</h3>
            ...
            {isProcessing && (
              <div className="bg-white rounded-lg shadow-sm p-6">
                <div className="flex items-center justify-center">
                  ...
                  <div>
                    <h3 className="font-semibold">Analyzing your problem...</h3>
          ...
          <div className="mt-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {scanHistory.slice(0, 4).map((scan) => (
                <div key={scan.id} className="bg-white rounded-lg shadow-sm p-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <p className="font-medium text-gray-900 mb-1">{scan.question}</p>
                      <p className="text-sm text-green-600 mb-2">Answer: {scan.solution}</p>
